    ...
    <div class="max-w-3xl mx-auto mt-6 bg-white shadow rounded-lg p-6">
        ...
        <div id="tags-list" class="mb-3 flex flex-wrap gap-2">
            @foreach($issue->tags as $tag)
                <span class="badge bg-secondary flex items-center gap-1 px-2 py-1 rounded">
                    {{ $tag->name }}
        ...
        <form id="comment-form" class="mb-4">
            ...
            <div class="mb-2">
                ...
                <div class="text-danger text-sm" id="author_name_error"></div>
            </div>
            <div class="mb-2">
                <textarea name="body" id="body" class="form-control" placeholder="Comment" required></textarea>
                <div class="text-danger text-sm" id="body_error"></div>
            </div>
        ...
        <h3 class="mb-2">Assigned Members</h3>
        <ul id="member-list" class="mb-3 space-y-1">
        ...
        <form id="add-member-form" class="mb-4 flex gap-2 items-center">
            @csrf
            <select name="user_id" id="user_id" class="form-control flex-1">
                ...
                .then(data => {
                    if(data.ok){
                        ...
                        if(attachedTag){
                            ...
                            const tagHtml = `<span class="badge bg-secondary flex items-center gap-1 px-2 py-1 rounded">
                            ${attachedTag.name}
